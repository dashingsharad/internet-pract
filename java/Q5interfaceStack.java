...
class IStaticStack implements Stack
{
	int top=-1,arr[];

//##################### CONSTRUCTOR STATIC STACK ######################	
	
	public IStaticStack(int n)
	{
		arr=new int[n];
	}
...
class IDynamicStack implements Stack
{
	int top;
...
//##################### STATIC STACK MENU FUNCTION ######################
	...
	public void S_STACK()
	{
		...
		s_size=s.nextInt();
		IStaticStack SS=new IStaticStack(s_size);
		while(rs==1)
		{
			System.out.println("\n	*****	MENU 	*****");
   			System.out.println("\n1.PUSH");
...
//##################### DYNAMIC STACK MENU FUNCTION ######################	
	...
	public void D_STACK()
	{
		IDynamicStack DS=new IDynamicStack();
		while(rs==1)
		{
			System.out.println("\n	*****	MENU 	*****");
   			System.out.println("\n1.PUSH");
...
//******************* CLASS INTERFACE STACK (MAIN FUNCTION CLASS)*************************

public class Q5interfaceStack
{
